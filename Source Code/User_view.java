...
public class User_view extends javax.swing.JFrame {
     ...
     */
    public User_view() {
        //Userlogin objectUserLogInClass = new User_login();
        initComponents();
        //getid.setText(User_login.userID);
        String Id=User_login.userID.toString();
        System.out.println("User ID in User View Class:"+ User_login.userID);
